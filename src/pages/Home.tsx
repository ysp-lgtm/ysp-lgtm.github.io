...
export default function Home() {
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="flex-1 flex items-center justify-center px-4 sm:px-6 py-20 md:py-32 relative">
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          {/* Name */}
          <h1 className="font-['Playfair_Display'] text-4xl sm:text-5xl md:text-7xl font-normal text-[var(--foreground)] mb-6 leading-[1.1] tracking-tight">
            杨少平
          </h1>
          ...
          <p className="text-base md:text-lg text-[var(--muted-foreground)] mb-12 max-w-xl mx-auto leading-relaxed tracking-[0.01em]">
            3年ToB产品经理经验，主导AI翻译平台、AI风险检测系统从0到1落地。
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
            <div className="text-center min-w-0">
              <p className="font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl font-normal text-[var(--foreground)] mb-2">
                3+
              </p>
              <p className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.1em] text-[var(--muted-foreground)] break-words">
                年产品经验
              </p>
            </div>
            <div className="text-center min-w-0">
